...
export default function UserDropdown() {
  ...
  const logout = useAuthStore((state) => state.logout) // Obtiene logout desde Zustand
  const navigate = useNavigate() // Para redirigir tras el logout
  ...
  function handleSignOut(e: React.MouseEvent<HTMLButtonElement>) {
    ...
    navigate('/signin') // Redirige sin forzar un recarga
  }
  ...
  return (
    <div className='relative'>
      ...
      >
        <span className='mr-3 relative flex items-center justify-center text-gray-500 transition-colors bg-white border border-gray-200 rounded-full hover:text-gray-700 h-11 w-11 hover:bg-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white'>
      ...
      {isOpen && (
        ...
        >
          ...
          {/* Sign Out con la lógica de cierre de sesión */}
          <button
